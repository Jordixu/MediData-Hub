...
class AdminMainScreen(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        ctk.CTkLabel(header_frame, text="Admin Dashboard", 
        ...
        self.create_button(menu_frame, "Patients", "AdminPatients", 0, 0, button_font, button_height)
        self.create_button(menu_frame, "Doctors", "AdminDoctors", 0, 1, button_font, button_height)
        self.create_button(menu_frame, "Drugs", "AdminDrugs", 0, 2, button_font, button_height)
        self.create_button(menu_frame, "Appointments", "AdminAppointments", 1, 0, button_font, button_height)
        self.create_button(menu_frame, "Notifications", "AdminNotifications", 1, 1, button_font, button_height)
        self.create_button(menu_frame, "Rooms", "AdminRooms", 1, 2, button_font, button_height)
