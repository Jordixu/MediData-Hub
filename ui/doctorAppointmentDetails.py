...
class DoctorAppointmentDetails(ctk.CTkFrame):
    def __init__(self, parent, controller):
        super().__init__(parent)
        self.controller = controller
        self.title = "Doctor Appointment Details"
    ...
    def load_data(self):
        ...
        self.title_entry.insert(0, self.controller.selected_appointment.get("title"))
        self.description_entry.insert(1.0, self.controller.selected_appointment.get("message"))
